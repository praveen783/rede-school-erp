        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="form-head d-flex align-items-center mb-4">
                    <div class="me-auto">
                        <h2 class="text-black font-w700 mb-0">Create Exam</h2>
                        <p class="mb-0 text-muted">
                            Exam will be created for the selected class & section
                        </p>
                    </div>
                </div>
                        ...
                        <form id="createExamForm">
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-3 mb-3">
                                ...
                                <!-- Exam Type
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Exam Type / Category</label>
                                    <input
                                        type="text"
                                        class="form-control"
                                        id="examType"
                                        placeholder="e.g. Unit Test, Mid Term, Internal, Final"
                                    >
                                </div> -->
                            ...
                            <div class="text-end mt-4">
                                <a href="examinations.html" class="btn btn-light me-2">
                                    Cancel
                                </a>
...
<script>
    ...
    let classSectionMap = {}; // { classId: [sections] }
    ...
    function prepareClassSectionMap(data) {
        classSectionMap = {};

        data.forEach(item => {
            if (!classSectionMap[item.class_id]) {
                classSectionMap[item.class_id] = {
                    class_name: item.class_name,
                    sections: []
                };
            }

            classSectionMap[item.class_id].sections.push({
                id: item.section_id,
    ...
    function populateClassDropdown() {
        ...
        Object.keys(classSectionMap).forEach(classId => {
            const option = document.createElement("option");
            option.value = classId;
            option.textContent = classSectionMap[classId].class_name;
    ...
    classSelect.addEventListener("change", function () {
        ...
        const sections = classSectionMap[selectedClassId].sections;
    ...
    form.addEventListener("submit", function (e) {
        ...
        // Basic validation
        if (!payload.name || !payload.class_id || !payload.section_id) {
            alert("Please fill all required fields");
            return;
        }

        apiRequest("POST", "/exams", payload)
            .done(function () {
            ...
            if (err.status === 422 && err.responseJSON && err.responseJSON.errors) {
                ...
                Object.values(err.responseJSON.errors).forEach(function (fieldErrors) {
