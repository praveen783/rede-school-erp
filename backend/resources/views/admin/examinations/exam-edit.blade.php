                    ...
                    <div class="card-body">
                        ...
                        <form id="editExamForm">
                            ...
                            <div class="mt-4">
                                ...
                                <a href="exam-list.html" class="btn btn-light ms-2">
                                    Cancel
                                </a>
                            </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        apiRequest("GET", `/exams/${examId}`)
            .done(exam => {
                ...
                if (exam.is_result_published) {
                    document
                    .querySelectorAll("#editExamForm input, #editExamForm select")
        ...
        document
            ...
            .addEventListener("submit", function (e) {
                ...
                apiRequest("PUT", `/exams/${examId}`, payload)
                    .done(() => {
