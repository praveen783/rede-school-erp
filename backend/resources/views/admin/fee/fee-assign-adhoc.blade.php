                ...
                <div class="col-xl-8 offset-xl-2">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0">Assign Special Fee</h4>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="feeTitle" class="form-control">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Amount (₹)</label>
                                <input type="number" id="feeAmount" class="form-control" min="1">
                            </div>
                            ...
                            <div id="assignMessage" class="mt-3"></div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    apiRequest("GET", "/classes")
        .done(function (res) {
            ...
            const classes = res.data ?? res; // handles pagination or plain array
    ...
    classSelect.addEventListener("change", function () {
        ...
        apiRequest("GET", `/sections?class_id=${classId}`)
            .done(function (res) {
                ...
                const sections = res.data ?? res; // safe handling
    ...
    assignBtn.addEventListener("click", function () {
        ...
        // Validation
        if (!classId) {
            messageBox.innerHTML = '<div class="text-danger">Please select class.</div>';
            return;
        }

        if (!title) {
            messageBox.innerHTML = '<div class="text-danger">Please enter fee title.</div>';
            return;
        }

        if (!amount || parseFloat(amount) <= 0) {
            messageBox.innerHTML = '<div class="text-danger">Please enter valid amount.</div>';
            return;
        }
        ...
        apiRequest("POST", "/fee-assignments/adhoc", {
            class_id: classId,
        ...
        .done(function (res) {
            ...
            messageBox.innerHTML =
                '<div class="text-success">Fee assigned successfully!</div>';
        ...
        .always(function () {
            ...
            assignBtn.innerText = "Assign Fee";
        });
