            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Fee Heads</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Add Fee Head</h5>
                            </div>
                            <div class="card-body">
                                <form id="feeHeadForm" class="row g-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="feeCode" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Description</label>
                                        <input type="text" class="form-control" id="feeDescription">
                                    </div>
                                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Fee Heads List</h5>
                            </div>
                            <div class="card-body">
...
<script>
    ...
    function loadFeeHeads() {
        apiRequest("GET", "/fee-heads")
            .done(function (data) {
                const tbody = document.getElementById("feeHeadsTable");
                tbody.innerHTML = "";
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-warning"
                                    onclick="toggleFeeHeadStatus(${fee.id})">
                                    Toggle
                                </button>
                            </td>
                        </tr>
    ...
    function toggleFeeHeadStatus(id) {
        apiRequest("PATCH", `/fee-heads/${id}/toggle-status`)
            .done(function () {
                loadFeeHeads();
            })
            .fail(function () {
    ...
    window.toggleFeeHeadStatus = toggleFeeHeadStatus;

    document.getElementById("feeHeadForm").addEventListener("submit", function (e) {
        e.preventDefault();

        apiRequest("POST", "/fee-heads", {
            name: feeName.value,
            code: feeCode.value,
