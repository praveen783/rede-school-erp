                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{url('/admin/fee/fee-structure')}}" class="btn btn-secondary mt-3">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    apiRequest("GET", "/me").done(res => {
        ...
        document.getElementById("headerUserRole").innerText =
            res.role === "super_admin" ? "Super Admin" : "School Admin";
    });

    /* GET STRUCTURE ID (FIXED) */
    ...
    apiRequest("GET", `/fee-structures/${structureId}`)
        .done(res => {
            ...
            document.getElementById("structureInfo").innerText =
                `${res.name} | ${res.class.name} | ${res.academic_year.name} | ACTIVE`;
