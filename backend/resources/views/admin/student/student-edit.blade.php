...
<div class="header">
    ...
    <div class="deznav-scroll">
        ...
        ***********************************-->
        <div class="content-body  ">
            ...
            <div class="row mb-4">
                <div class="col">
                    <h2 class="text-black font-w700">Edit Student</h2>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="studentEditForm">
                                ...
                                <!-- Admission No -->
                                <div class="row mb-3">
                                    <label class="col-md-3 col-form-label">Admission No</label>
                                    <div class="col-md-6">
                                        <input
                                            type="text"
                                            id="admissionNo"
    ...
    ***********************************-->
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const studentId =
            pathParts[pathParts.indexOf("students") + 1];
        ...
        apiRequest("GET", `/students/${studentId}`)
            .done(function (student) {
                ...
                document.getElementById("dateOfJoining").value = student.date_of_joining ?? "";
                document.getElementById("address").value = student.address ?? "";
                document.getElementById("status").value = student.is_active ? 1 : 0;

                window.selectedClassId   = student.class_id;
                window.selectedSectionId = student.section_id;
        ...
        function loadClasses()
        {
            ...
            .done(function (res)
            {
                ...
                {
                    loadSections(window.selectedClassId);
                }
            })
            .fail(function ()
            {
        ...
        function loadSections(classId)
        {
            ...
            .done(function (res)
            {
                ...
                {
                    const selected =
                        sec.id == window.selectedSectionId
                            ? "selected"
                            : "";
        ...
        document.getElementById("studentEditForm").addEventListener("submit", function (e) {
            ...
            apiRequest("PUT", `/students/${studentId}`, payload)
                .done(function () {
