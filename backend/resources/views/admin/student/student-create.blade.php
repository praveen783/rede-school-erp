...
<div class="header">
        ...
        <div class="card-body">
            <form id="studentAdmissionForm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label>Class</label>
                        <select id="class_id" class="form-control selectpicker" data-live-search="true">
                    ...
                    <div class="col-md-4 mb-3">
                        <label>Section</label>
                        <select id="section_id" class="form-control selectpicker">
                ...
                <div class="text-end mt-3">
                    <a href="student.html" class="btn btn-secondary">Cancel</a>
   ...
   <!-- Scripts -->
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        $('#class_id').on('changed.bs.select', function ()
        {
        ...
        STEP 1: CAPTURE & VERIFY PAYLOAD
        =============================== */
        document
        .getElementById("studentAdmissionForm")
        .addEventListener("submit", function (e) {
            ...
            apiRequest("POST", "/students", payload)
                .done(function (res) {
                    ...
                    setTimeout(() => {
                        window.location.href = "{{ url('/admin/parents/create') }}";  
                    }, 800);
                })
                .fail(function (err) {
                    ...
                    if (err.responseJSON?.errors) {
                        const messages = Object.values(err.responseJSON.errors)
                            .flat()
                            .join("\n");
                        alert(messages);
                    } else {
