...
<head>	
	<!-- Title -->
	<title>Owlio Laravel | Teachers</title>
	...
	<meta property="og:description" content="Owlio Laravel | Teachers" />
...
<div class="header">
    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <!-- HEADER / TOOLBAR -->
            <div class="form-head d-flex align-items-center justify-content-between mb-4">
                ...
                <div class="d-flex align-items-center gap-4">
                    ...
                    <!-- SEARCH FIELD (NEAR TEACHERS TITLE) -->
                    <div class="input-group search-area d-lg-flex d-none" style="width: 260px;">
                        <input
                            type="text"
                            class="form-control"
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <select class="form-control default-select style-3">
                    ...
                    <a href="{{ url('/admin/teachers/create') }}"
                        ...
                        <i class="fa fa-user-plus me-3"></i>New Teacher
                    </a>
...
function loadTeachers()
{
    ...
    .done(function(res)
    {
        // Supports both paginated and non-paginated API
        allTeachers =
            res.data ?? res ?? [];
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="mb-1">
                                ...
                                <a
                                    href="/admin/teachers/profile/${teacher.id}"
                                    class="text-black">
