...
<head>	
    ...
    <style>
        /* =====================================================
           ADD TEACHER FORM — DARK MODE AWARE STYLES
        ===================================================== */
        ...
        .at-page-header .at-breadcrumb {
            font-size: 13px;
            color: var(--text-muted, #6c757d);
        }
        .at-page-header .at-breadcrumb a {
            color: #1e33f2;
        ...
        #addTeacherCard .card-header .at-icon {
            width: 36px;
            height: 36px;
            border-radius: 8px;
            background: linear-gradient(135deg, #1e33f2, #1ee5f2);
            display: flex;
            align-items: center;
        ...
        #addTeacherCard .card-header .card-title {
            margin: 0;
            font-size: 16px;
            font-weight: 700;
        }
        ...
        .at-section-label {
            ...
            border-bottom: 2px solid #1e33f220;
            margin-bottom: 1rem;
        }
        ...
        @media (max-width: 640px) {
            ...
            .at-form-grid .at-col-full { grid-column: 1; }
        }

        /* -- Labels -- */
        #addTeacherForm label.form-label {
            font-size: 13px;
            font-weight: 600;
            margin-bottom: .35rem;
            display: block;
        ...
        /* ---- LIGHT MODE inputs ---- */
        #addTeacherForm .form-control,
        #addTeacherForm .btn-light {
            border-radius: 8px;
            font-size: 14px;
        ...
        #addTeacherForm .form-control::placeholder {
            color: #aab2bd;
        }
        #addTeacherForm .form-control:focus {
            border-color: #1e33f2;
            box-shadow: 0 0 0 3px rgba(30,51,242,.12);
            outline: none;
            background-color: #ffffff;
            color: #1d2939;
        }
        #addTeacherForm textarea.form-control {
            resize: vertical;
            min-height: 90px;
        }

        /* ---- DARK MODE inputs ---- */
        [data-theme="dark"] #addTeacherForm .form-control,
        .dark-mode #addTeacherForm .form-control,
        body.dark #addTeacherForm .form-control {
            background-color: #1e2139 !important;
            border-color: #3a3f5c !important;
            color: #e4e6f0 !important;
        }
        [data-theme="dark"] #addTeacherForm .form-control::placeholder,
        .dark-mode #addTeacherForm .form-control::placeholder,
        body.dark #addTeacherForm .form-control::placeholder {
            color: #6b7280 !important;
        }
        [data-theme="dark"] #addTeacherForm .form-control:focus,
        .dark-mode #addTeacherForm .form-control:focus,
        body.dark #addTeacherForm .form-control:focus {
            border-color: #4f6bff !important;
            box-shadow: 0 0 0 3px rgba(79,107,255,.18) !important;
            background-color: #252945 !important;
            color: #f0f2ff !important;
        }

        /* dark mode for select options dropdown */
        [data-theme="dark"] #addTeacherForm select option,
        .dark-mode #addTeacherForm select option,
        body.dark #addTeacherForm select option {
            background-color: #1e2139;
            color: #e4e6f0;
        }

        /* -- Status badge select pill -- */
        #teacherStatus {
            appearance: none;
        ...
        .at-form-actions .btn-primary {
            ...
            background: linear-gradient(135deg, #1e33f2, #1ee5f2);
            border: none;
            box-shadow: 0 3px 10px rgba(30,51,242,.25);
            transition: opacity .2s, box-shadow .2s;
        }
        .at-form-actions .btn-primary:hover {
            opacity: .9;
            box-shadow: 0 4px 14px rgba(30,51,242,.35);
        }
        .at-form-actions .btn-light {
            padding: 9px 22px;
            font-size: 14px;
            font-weight: 500;
            border-radius: 8px;
        ...
        body.dark .at-form-actions .btn-light {
            border-color: #3a3f5c;
            color: #c9cde8;
            background-color: #1e2139;
        }
        ...
        /* ---- Repeater Cards (education / experience) ---- */
        .at-repeater-card {
        ...
        body.dark .at-repeater-card {
            background-color: #191c34;
            border-color: #2e3154;
        }
        .at-repeater-card .at-remove-btn {
            position: absolute;
            top: .6rem;
            right: .75rem;
            background: none;
        ...
        .at-repeater-card .at-remove-btn:hover {
            background: rgba(240,68,56,.08);
        }
        .at-repeater-card .at-card-title {
            font-size: 12px;
            font-weight: 700;
            color: #1e33f2;
            text-transform: uppercase;
        ...
        /* Add button */
        .at-add-btn {
            background: rgba(30,51,242,.08);
            color: #1e33f2;
            border: 1.5px dashed #1e33f2;
            border-radius: 7px;
            font-size: 12px;
            font-weight: 600;
            padding: 4px 14px;
        ...
        body.dark .at-repeater-card .form-control::placeholder {
            color: #6b7280 !important;
        }
        [data-theme="dark"] .at-repeater-card .form-control:focus,
        .dark-mode .at-repeater-card .form-control:focus,
        body.dark .at-repeater-card .form-control:focus {
            border-color: #4f6bff !important;
            box-shadow: 0 0 0 3px rgba(79,107,255,.18) !important;
            background-color: #252945 !important;
            color: #f0f2ff !important;
    ...
    ***********************************-->
    ...
    <div class="col-xl-9 col-lg-10 col-md-12 mx-auto">
        ...
        <div class="at-page-header">
            <div>
                <h4 class="mb-1" style="font-weight:700;">Add New Teacher</h4>
                ...
                <form id="addTeacherForm">
                    ...
                    <div class="at-form-grid mb-3">
                        ...
                        <div class="mb-3 at-col-full">
                            ...
                            <textarea class="form-control" id="teacherAddress"
                                rows="3" placeholder="Street, City, State, PIN"></textarea>
                        </div>
                    ...
                    <div class="at-form-grid mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="primarySubject"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="secondarySubject"
                                placeholder="e.g. Science">
                        </div>

                        <!-- Subjects multi-select (full width) -->
                        <div class="mb-3 at-col-full">
                            <label class="form-label">
                                Assigned Subjects <span class="at-req">*</span>
                            </label>
                            <select
                                id="subjectsSelect"
                    ...
                    <div id="educationsList">
                        <!-- Education rows injected here by JS -->
                    </div>
                    ...
                    <div id="experiencesList">
                        <!-- Experience rows injected here by JS -->
                    </div>

                    <!-- ===== ACTION BUTTONS ===== -->
                    <div class="at-form-actions mt-3">
                        <button type="submit" id="saveTeacherBtn" class="btn btn-primary">
                            <i class="fa fa-save me-2"></i> Save Teacher
                        </button>
                        <a href="{{ url('/admin/teachers') }}" class="btn btn-light">
                            Cancel
                        </a>
                    </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function addEducationRow(data) {
        ...
        <div class="at-repeater-card" id="edu-row-${idx}">
            <button type="button" class="at-remove-btn" onclick="removeRow('edu-row-${idx}')">
            ...
            <div class="at-form-grid">
                <div class="mb-3">
                    ...
                    <select class="form-control edu-degree">
                        <option value="">— Select degree —</option>
                        <option value="SSC / 10th" ${d.degree==='SSC / 10th'?'selected':''}>SSC / 10th</option>
                        <option value="HSC / 12th" ${d.degree==='HSC / 12th'?'selected':''}>HSC / 12th</option>
                        <option value="Diploma" ${d.degree==='Diploma'?'selected':''}>Diploma</option>
                        <option value="B.A" ${d.degree==='B.A'?'selected':''}>B.A</option>
                        <option value="B.Sc" ${d.degree==='B.Sc'?'selected':''}>B.Sc</option>
                        <option value="B.Com" ${d.degree==='B.Com'?'selected':''}>B.Com</option>
                        <option value="B.Tech / B.E" ${d.degree==='B.Tech / B.E'?'selected':''}>B.Tech / B.E</option>
                        <option value="B.Ed" ${d.degree==='B.Ed'?'selected':''}>B.Ed</option>
                        <option value="M.A" ${d.degree==='M.A'?'selected':''}>M.A</option>
                        <option value="M.Sc" ${d.degree==='M.Sc'?'selected':''}>M.Sc</option>
                        <option value="M.Com" ${d.degree==='M.Com'?'selected':''}>M.Com</option>
                        <option value="M.Tech / M.E" ${d.degree==='M.Tech / M.E'?'selected':''}>M.Tech / M.E</option>
                        <option value="M.Ed" ${d.degree==='M.Ed'?'selected':''}>M.Ed</option>
                        <option value="MBA" ${d.degree==='MBA'?'selected':''}>MBA</option>
                        <option value="Ph.D" ${d.degree==='Ph.D'?'selected':''}>Ph.D</option>
                        <option value="Other" ${d.degree==='Other'?'selected':''}>Other</option>
                    </select>
                </div>
                <div class="mb-3">
                    <label class="form-label">Field of Study / Specialization</label>
                    <input type="text" class="form-control edu-field" placeholder="e.g. Mathematics, Computer Science" value="${d.field_of_study||''}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control edu-board" placeholder="e.g. CBSE, Mumbai University" value="${d.board_or_university||''}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control edu-result">
                        <option value="">— Select result —</option>
                        <option value="Distinction" ${d.result==='Distinction'?'selected':''}>Distinction</option>
                        <option value="First Class" ${d.result==='First Class'?'selected':''}>First Class</option>
                        <option value="Second Class" ${d.result==='Second Class'?'selected':''}>Second Class</option>
                        <option value="Pass Class" ${d.result==='Pass Class'?'selected':''}>Pass Class</option>
                    </select>
                </div>
                <div class="mb-3">
    ...
    function addExperienceRow(data) {
        ...
        <div class="at-repeater-card" id="exp-row-${idx}">
            <button type="button" class="at-remove-btn" onclick="removeRow('exp-row-${idx}')">
                <i class="fa fa-times"></i>
            </button>
            ...
            <div class="at-form-grid">
                ...
                <div class="mb-3 d-flex align-items-center gap-2 pt-4">
                    ...
                    <label class="form-check-label mb-0" for="expCurrent${idx}" style="font-weight:600;font-size:13px;">
                        Currently Working Here
                    </label>
                </div>
                <div class="mb-3 at-col-full">
                    <label class="form-label">Key Responsibilities</label>
                    <textarea class="form-control exp-resp" rows="2" placeholder="Brief description of role and responsibilities...">${d.responsibilities||''}</textarea>
                </div>
                <div class="mb-3">
    ...
    form.addEventListener("submit", function (e) {
        ...
        document.querySelectorAll("#educationsList .at-repeater-card").forEach(function(card) {
            ...
            if (!degree || !institution) return; // skip empty/incomplete
            educations.push({
                degree:             degree,
        ...
        const payload = {
            ...
            primary_subject:  document.getElementById("primarySubject").value.trim(),
            secondary_subject:document.getElementById("secondarySubject").value.trim(),
        ...
        // ================================
        // CREATE TEACHER API CALL
        // ================================
        apiRequest("POST", "/teachers", payload)
            ...
            .fail(function (err) {
                console.error(err);
                alert(err.responseJSON?.message || "Failed to add teacher");
            })

            .always(function () {
                btn.disabled = false;
                btn.innerHTML = '<i class="fa fa-save me-2"></i> Save Teacher';
            });
...
function loadSubjects()
{
    ...
    apiRequest("GET", "/subjects")
        ...
        .done(function (res)
        {
            ...
            const select =
                document.getElementById("subjectsSelect");
...
// ================================
// TOGGLE "To Date" WHEN CURRENTLY WORKING
// ================================
