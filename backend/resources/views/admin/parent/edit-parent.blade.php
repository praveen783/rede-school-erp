                        ...
                        <div class="card-body">
                            ...
                            <form id="editParentForm">
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <a href="{{ url('/admin/parents') }}" class="btn btn-light px-4">
                                        Cancel
                                    </a>
                                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function ()
    {
        ...
        .addEventListener("submit", function(e)
        {
            ...
            apiRequest("PUT", `/parents/${parentId}`, payload)
            .done(function()
            {
