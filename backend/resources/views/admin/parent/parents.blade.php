    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ url('/admin/parents/create') }}" class="btn btn-primary">+ Add Parent</a>
            </div>
            ...
            <div class="row" id="parentsList">
                <!-- Parents cards will be injected here -->
            </div>
    ...
    ***********************************-->
                        ...
                        <div class="card h-100 shadow-sm">
                            <div class="card-body d-flex flex-column">
                                ...
                                <p class="mb-1 d-flex">
                                    ...
                                    <span class="text-truncate" title="${parent.email ?? '-'}">
                                        ${parent.email ?? "-"}
                                    </span>
                                </p>
        ...
        window.viewParent = function (parentId)
    {
        window.location.href =
            `/admin/parents/profile/${parentId}`;
    };
