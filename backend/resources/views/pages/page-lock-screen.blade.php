...
<!-- Mirrored from owlio.dexignzone.com/laravel/demo/page-lock-screen by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Jan 2026 04:38:38 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>	
	<!-- Title -->
	<title>Owlio Laravel | Page Lock Screen</title>
	...
	<meta property="og:description" content="Owlio Laravel | Page Lock Screen" />
        ...
        <div class="row no-gutters">
            <div class="col-xl-12">
                <div class="auth-form">
                    ...
                    <form action="https://owlio.dexignzone.com/laravel/demo/index">
                        <input type="hidden" name="_token" value="7r9S4OG6empHntcP96fML3XOHxxVRRnoFgVf21eo">                        <div class="form-group">
...
***********************************-->
    <!-- Required vendors -->
            ...
            <script src="public/vendor/bootstrap-select/dist/js/bootstrap-select.min.js" type="text/javascript"></script>
                        <script src="public/vendor/deznav/deznav.min.js" type="text/javascript"></script>
                        <script src="public/js/custom.min.js" type="text/javascript"></script>
            <script src="public/js/deznav-init.js" type="text/javascript"></script>
        
    </body>

<!-- Mirrored from owlio.dexignzone.com/laravel/demo/page-lock-screen by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Jan 2026 04:38:39 GMT -->
</html>