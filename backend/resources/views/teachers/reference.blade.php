...
<html lang="en">
<head>
    <title>Owlio | Teacher - My Classes</title>
...
<div id="main-wrapper">
    ...
    <div class="nav-header">
            <a href="../dashboard-teacher.html" class="brand-logo">
    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="../dashboard-teacher.html" class="ai-icon">
                ...
                <li class="mm-active">
                    <a href="teacher-classes.html" class="ai-icon">
                ...
                <li>
                    <a href="teacher-attendance.html" class="ai-icon">
                ...
                <li>
                    <a href="teacher-marks.html" class="ai-icon">
